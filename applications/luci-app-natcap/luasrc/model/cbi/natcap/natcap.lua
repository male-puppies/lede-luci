...
e = s:option(Flag, "dns_proxy_force", translate("Force DNS Proxy"), translate("Enable will force all dns querys to proxy server"))
e.default = e.disabled
e.rmempty = false

e = s:option(Flag, "shadowsocks", translate("Enable shadowsocks speed up"), translate("Enable will force tcp redir to shadowsocks"))
e.default = e.disabled
e.rmempty = false
